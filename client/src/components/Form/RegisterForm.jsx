...
const RegisterForm = ({ formRef }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col">
                <ul className="h-[290px]  w-[305px] text-left mb-4  p-2 bg-gray-100 rounded-xl pointer-events-none select-none">
                    <div className="my-1 pl-2">Fullname must:</div>
                    {fullNameAndEmailErrors?.nameErrors?.length === 0 && (
                        <div className="flex flex-col gap-2 pl-2 text-sm  text-red-500 items-center">
                            <span className="pl-2 text-xs mt-0.5 h-[15px] shimmer w-full rounded-sm"></span>
                            <span className="pl-2 text-xs h-[15px] shimmer w-full rounded-sm"></span>
                        </div>
                    )}
                    ...
                    {passErrors?.length === 0 && (
                        <div className="flex flex-col gap-2 pl-2 text-sm  text-red-500 items-center">
                            <span className="pl-2 mt-0.5 text-xs h-[15px] shimmer w-full rounded-sm"></span>
                            <span className="pl-2 text-xs h-[15px] shimmer w-full rounded-sm"></span>
                            <span className="pl-2 text-xs h-[15px] shimmer w-full rounded-sm"></span>
                            <span className="pl-2 text-xs h-[15px] shimmer w-full rounded-sm"></span>
                            <span className="pl-2 text-xs h-[15px] shimmer w-full rounded-sm"></span>
